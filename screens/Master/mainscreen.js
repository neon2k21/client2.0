    ...
    <Modal
        ...
        <View className="flex-1 justifyContent-center" >
          <View style={{
            ...
            <Text className="text-2xl font-bold" style={{color:'black', marginVertical:widthPercentageToDP(0)}}>
              Фильтры:
            </Text>
            <Text className="text-2xl font-bold" style={{color:'black', marginVertical:widthPercentageToDP(1)}}>
            ...
            <Pressable
              ...
              onPress={() => {setModalVisible(!modalVisible);  useFilters(); }}>
              <Text style={{
                 color: 'black',
                 fontWeight: 'bold',
                 textAlign: 'center'
